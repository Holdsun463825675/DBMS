...
function GuestPapers() {
    ...
    const filteredPapers = papers.filter((paper) => {
        ...
        if (searchType === "title" && paper.is_public===true) {
            return paper.title.toLowerCase().includes(searchQuery.toLowerCase());
        } else if (searchType === "author" && paper.is_public===true) {
            return paper.author.toLowerCase().includes(searchQuery.toLowerCase());
        } else if (searchType === "date" && paper.is_public===true) {
    ...
    return (
        <div>
            ...
            {/*    添加论文*/}
            {/*</Button>*/}
            <GuestPaperList papers={filteredPapers}
